...
Partial Public NotInheritable Class ThisDocument
    ...
    Friend WithEvents ProductIDNode As Microsoft.Office.Tools.Word.XMLNode

    Friend WithEvents ProductNameNode As Microsoft.Office.Tools.Word.XMLNode

    Friend WithEvents QuantityPerUnitNode As Microsoft.Office.Tools.Word.XMLNode

    Friend WithEvents UnitPriceNode As Microsoft.Office.Tools.Word.XMLNode
    ...
    Private Sub BeginInitialization()
        ...
        Me.ProductIDNode.BeginInit()
        Me.ProductNameNode.BeginInit()
        Me.QuantityPerUnitNode.BeginInit()
        Me.UnitPriceNode.BeginInit()
    End Sub
    ...
    Private Sub EndInitialization()
        Me.UnitPriceNode.EndInit()
        Me.QuantityPerUnitNode.EndInit()
        Me.ProductNameNode.EndInit()
        Me.ProductIDNode.EndInit()
    ...
    Private Sub InitializeControls()
        ...
        Me.ProductIDNode = New Microsoft.Office.Tools.Word.XMLNode(Me.HostItemHost, Me.RuntimeCallback, "/ns0:ProductID xmlns:ns0='http://tempuri.org/SmartInvoice2005.xsd'", Me, "ProductIDNode")
        Me.ProductNameNode = New Microsoft.Office.Tools.Word.XMLNode(Me.HostItemHost, Me.RuntimeCallback, "/ns0:ProductName xmlns:ns0='http://tempuri.org/SmartInvoice2005.xsd'", Me, "ProductNameNode")
        Me.QuantityPerUnitNode = New Microsoft.Office.Tools.Word.XMLNode(Me.HostItemHost, Me.RuntimeCallback, "/ns0:QuantityPerUnit xmlns:ns0='http://tempuri.org/SmartInvoice2005.xsd'", Me, "QuantityPerUnitNode")
        Me.UnitPriceNode = New Microsoft.Office.Tools.Word.XMLNode(Me.HostItemHost, Me.RuntimeCallback, "/ns0:UnitPrice xmlns:ns0='http://tempuri.org/SmartInvoice2005.xsd'", Me, "UnitPriceNode")
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        CType(Me.ProductIDNode, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.ProductNameNode, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.QuantityPerUnitNode, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.UnitPriceNode, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me, System.ComponentModel.ISupportInitialize).BeginInit()
        '
        'ThisDocument
        '
        CType(Me.ActionsPane, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ProductIDNode, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ProductNameNode, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.QuantityPerUnitNode, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.UnitPriceNode, System.ComponentModel.ISupportInitialize).EndInit()
